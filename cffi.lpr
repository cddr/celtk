...
(define-project :name :cffi
  :modules (list (make-instance 'module :name "src\\utils.lisp")
                 (make-instance 'module :name "src\\features.lisp")
                 (make-instance 'module :name "src\\cffi-allegro.lisp")
                 (make-instance 'module :name "src\\package.lisp")
                 (make-instance 'module :name "src\\libraries.lisp")
                 (make-instance 'module :name "src\\early-types.lisp")
                 (make-instance 'module :name "src\\types.lisp")
                 (make-instance 'module :name "src\\enum.lisp")
                 (make-instance 'module :name "src\\strings.lisp")
                 (make-instance 'module :name "src\\functions.lisp")
                 (make-instance 'module :name "src\\foreign-vars.lisp")
